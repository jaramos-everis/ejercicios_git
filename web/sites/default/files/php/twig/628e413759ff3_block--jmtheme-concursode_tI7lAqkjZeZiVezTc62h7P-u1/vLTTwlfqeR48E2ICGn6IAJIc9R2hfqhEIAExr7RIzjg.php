...
/* themes/custom/jmtheme/templates/block/block--jmtheme-concursodetiraje.html.twig */
class __TwigTemplate_3072e1922145336d06515e1aba336f603b4919f53aac9ae246cf91dd7c927d00 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 37
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_link_block2", [], "any", false, false, true, 37), 37, $this->source), "html", null, true);
        echo "
    <p><a id= \"modal\" class=\"use-ajax\" data-dialog-options='{\"width\":\"100%\", \"height\":\"100%\", \"fluid\":\"true\", \"resizable\":\"false\", \"hide\":\"fadeOut\", \"show\":\"fadeIn\"}' data-dialog-type=\"modal\" href=\"/visita-la-fabrica\">Busqueda</a></p>
    </div>
  ";
    }
    ...
    {
        return "themes/custom/jmtheme/templates/block/block--jmtheme-concursodetiraje.html.twig";
    }
    ...
    {
        return array (  82 => 37,  78 => 36,  75 => 35,  71 => 34,  66 => 41,  64 => 34,  59 => 33,  51 => 31,  49 => 30,  45 => 29,  40 => 28,);
    }
...
<div{{ attributes }}>
  ...
  {% block content %}
    <div>
    {{ content.body }}
    {{ content.field_link_block2 }}
    <p><a id= \"modal\" class=\"use-ajax\" data-dialog-options='{\"width\":\"100%\", \"height\":\"100%\", \"fluid\":\"true\", \"resizable\":\"false\", \"hide\":\"fadeOut\", \"show\":\"fadeIn\"}' data-dialog-type=\"modal\" href=\"/visita-la-fabrica\">Busqueda</a></p>
    </div>
  {% endblock %}
</div>
", "themes/custom/jmtheme/templates/block/block--jmtheme-concursodetiraje.html.twig", "/app/web/themes/custom/jmtheme/templates/block/block--jmtheme-concursodetiraje.html.twig");
    }
